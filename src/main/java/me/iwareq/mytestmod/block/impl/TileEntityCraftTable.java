...
import me.iwareq.mytestmod.Recipe;
import me.iwareq.mytestmod.Recipes;
...
public class TileEntityCraftTable extends TileEntity implements ISidedInventory {
    ...
    public void updateEntity() {
        ...
        recipe = Recipes.getRecipe(inventory_input);
    ...
    private void SetContent() {
        for (int i = 0; i < 9; ++i) {
            ...
            if (int_input != null) {
                if (Objects.requireNonNull(int_input.getItem()).hasContainerItem(int_input)) {
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("CustomName", Constants.NBT.TAG_STRING)) setInventoryName(nbt.getString("CustomName"));
    }
